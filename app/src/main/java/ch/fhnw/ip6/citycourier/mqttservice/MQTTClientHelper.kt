...
class MqttClientHelper(activity:Activity) {
    ...
    val serverUri = HIVEMQ_MQTT_HOST
    ...
    private fun connect() {
        ...
        //mqttConnectOptions.userName = HIVEMQ_ANDROID_CLIENT_USER_NAME
        //mqttConnectOptions.password = HIVEMQ_ANDROID_CLIENT_PASSWORD.toCharArray()
