 ...
 */
@Composable
fun fetchOrder(id: String, ordersRepository: OrdersRepository): UiState<OrderDescriptiveInfo> {

    var orderState: UiState<OrderDescriptiveInfo> by state<UiState<OrderDescriptiveInfo>> { UiState.Loading }
    ...
    onActive {
        ordersRepository.getOrder(id) { result ->
